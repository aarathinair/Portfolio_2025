...
const skillCategories = [
  {
    ...
    data: [
      ...
      { skill: "Customer Discovery", value: 90 },
      { skill: "Agile/Scrum", value: 85 },
      { skill: "Go-To-Market", value: 80 },
      { skill: "A/B Testing & Experimentation", value: 88 },
      { skill: "Value Proposition Design", value: 92 },
    ],
    color: "#7c3aed",
  },
  {
    title: "AI & Technology",
    data: [
      { skill: "Multi-Agent Design", value: 90 },
      { skill: "AI Safety & Ethics", value: 90 },
  ...
  },
  {
    ...
    data: [
      ...
      { skill: "Amplitude/Mixpanel", value: 90 },
      { skill: "Jira/Asana", value: 95 },
      { skill: "SQL/Python", value: 90 },
      { skill: "Postman & API Testing", value: 85 },
      { skill: "Lovable/Vercel", value: 90 },
    ],
    color: "#8b5cf6",
  },
]
